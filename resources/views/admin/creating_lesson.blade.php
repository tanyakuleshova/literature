        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-md-6">
                    ...
                    <br>
                    <div class="row justify-content-md-center">
                        <h2 class="footer-heading mb-4">Створення уроку</h2>
                    </div>
                    <form method="post" action="/admin_lesson_store" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="Тема уроку">
                        </div>
                        <div class="form-group">
                            <label>Описання уроку</label>
